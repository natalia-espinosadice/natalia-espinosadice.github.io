  ...
  <div class="two-col">
    ...
    <div class ="rightcol">
        ...
        <p>  
            ...
            that outperformed existing state-of-the-art GAN and diffusion models, particularly when confronted with limited training samples. In subsequent work, this <a href = "#regression"> framework was extended with regression-based rewards </a> to improve the preservation of statistical relationships in synthetic data. I also contributed to the Synthetic AI-READI dataset, a multimodal synthetic cohort for Type 2 Diabetes research now publically available. 
        </p>
        <p>
        ...
        <div class="pub-card" id = "rlsyn">
          ...
          <a href="https://arxiv.org/abs/2512.21395">Preprint</a>
          <p>
